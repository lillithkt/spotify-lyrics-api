...
// .svelte-kit/output/server/chunks/headers.js
var baseHeaders;
...
async function getAccessToken() {
  try {
    const data = await fetch("https://open.spotify.com/get_access_token", {
      headers: {
        ...baseHeaders,
        Cookie: dc
      }
...
var SPOTIFY_COOKIE, AuthData, dc, handle;
var init_hooks_server = __esm({
  ".svelte-kit/output/server/chunks/hooks.server.js"() {
    init_headers();
    SPOTIFY_COOKIE = "AQCzQ9Mu5ao5dyq0yrxq3ys_DMWXp_A0MgHYYm1BhUk2FAFQKn38O-ybCfl1rrMkTXkSnABocEG1Nf7lWcn1m0VQq7wRGQKzcPnk-s5_MujmQDLODG7QwFNMJJdh5XAm2ruDXPXgrSgpaiW-Sof3D7H4ocnj7zaF";
    AuthData = null;
    dc = SPOTIFY_COOKIE.startsWith("sp_dc=") ? SPOTIFY_COOKIE : `sp_dc=${SPOTIFY_COOKIE}`;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.CM0wEr3t.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/chunks/index.COp9-3vz.js"];
    stylesheets = [];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.Bsxk6ij-.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/chunks/index.COp9-3vz.js", "_app/immutable/chunks/entry.Bmp-AC5S.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var regexes, dummySongId, Page;
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_ssr();
    regexes = "export const TrackIdRegex = /^[\\d\\w]{16,}$/;\nexport const TrackUriRegex = /^spotify:track:([\\d\\w]{16,})$/;\nexport const SongLinkRegex = /^https:\\/\\/open\\.spotify\\.com\\/track\\/([\\d\\w]{16,})/;\n";
    dummySongId = "5hVghJ4KaYES3BFUATCYn0";
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { data } = $$props;
      const paths = {
        Lyrics: ["/lyrics/songId", `/lyrics/${dummySongId}`],
        "Lyrics (keep metadata)": ["/lyrics/songId?meta", `/lyrics/${dummySongId}?meta`],
        "Lyrics (raw data from spotify)": ["/lyrics/songId?rawLyrics", `/lyrics/${dummySongId}?rawLyrics`]
      };
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `<div class="root"><h1 data-svelte-h="svelte-196521">Access Token Exists:</h1> <p>${escape(data.accessToken ? "Yes" : "No")}</p> <h1 data-svelte-h="svelte-lnwaah">Expiration:</h1> <p>${escape(data.accessTokenExpiration)}</p> <br> <br> <h1 data-svelte-h="svelte-2ni182">Paths:</h1> ${each(Object.entries(paths), ([name, [path, example]]) => {
        return `<h2>${escape(name)}</h2> <p>${escape(path)}</p> <a${add_attribute("href", example, 0)}>Example</a>`;
      })} <h1 data-svelte-h="svelte-1xfv0c7">songId Parameter</h1> <p data-svelte-h="svelte-n94p5k">SongId can match a song&#39;s id, a song&#39;s spotify url, and a song&#39;s media player url</p> <p data-svelte-h="svelte-v7gwog">The regexes used to match these are the following:</p> <code>${each(regexes.split("\n"), (line) => {
        return ` <pre>${escape(line)}</pre>`;
      })}</code> <a href="/types" data-svelte-h="svelte-13zp27o"><h1>Server Response Types</h1></a></div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.DkvL1Y7B.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/chunks/index.COp9-3vz.js", "_app/immutable/chunks/each.D6YF6ztN.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/types/_page.svelte.js
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.C7JKUc4Z.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/chunks/index.COp9-3vz.js", "_app/immutable/chunks/each.D6YF6ztN.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/chunks/regex.js
var TrackIdRegex, TrackUriRegex, SongLinkRegex;
var init_regex = __esm({
  ".svelte-kit/output/server/chunks/regex.js"() {
    TrackIdRegex = /^[\d\w]{16,}$/;
    TrackUriRegex = /^spotify:track:([\d\w]{16,})$/;
    SongLinkRegex = /^https:\/\/open\.spotify\.com\/track\/([\d\w]{16,})/;
  }
});

// .svelte-kit/output/server/chunks/responses.js
var noAuthToken, trackNotFound;
var init_responses = __esm({
  ".svelte-kit/output/server/chunks/responses.js"() {
    init_chunks();
    noAuthToken = () => error(401, "No Auth Token on server");
    trackNotFound = (trackId) => error(404, `Track ${trackId} not found`);
  }
});

// .svelte-kit/output/server/entries/endpoints/lyrics/_trackUri_trackUri_/_server.ts.js
...
var init_server_ts = __esm({
  ".svelte-kit/output/server/entries/endpoints/lyrics/_trackUri_trackUri_/_server.ts.js"() {
    ...
    GET = async ({ params, url }) => {
      ...
      const match4 = params.trackUri.match(TrackUriRegex);
      if (!match4) {
        return trackNotFound(params.trackUri);
      }
      const trackId = match4[1];
...
// .svelte-kit/output/server/entries/endpoints/lyrics/_trackId_trackId_/_server.ts.js
var server_ts_exports2 = {};
__export(server_ts_exports2, {
  GET: () => GET2
});
function filterMeta(lyrics) {
  const workingLyrics = lyrics;
...
function filterLyrics(lyrics, keepMeta = false) {
  let workingLyrics = lyrics;
  if (!keepMeta) {
    workingLyrics = filterMeta(workingLyrics);
  }
  switch (lyrics.lyrics.syncType) {
    ...
    case "LINE_SYNCED": {
      ...
      if (hasEndTimes) {
        workingLyrics.lyrics.lines = workingLyrics.lyrics.lines.map(
          (line) => ({
    ...
    default: {
      workingLyrics.comment = "Unknown sync type. Please report this to imlvna on github with the song id so i can impliment it!";
      break;
    }
  }
  return workingLyrics;
}
async function getRawLyrics(trackId, accessToken) {
  return await fetch(
...
async function getLyrics(trackId, accessToken, keepMeta = false) {
  return filterLyrics(await getRawLyrics(trackId, accessToken), keepMeta);
}
var GET2;
...
// .svelte-kit/output/server/entries/endpoints/lyrics/_...songLink_songLink_/_server.ts.js
...
var init_server_ts3 = __esm({
  ".svelte-kit/output/server/entries/endpoints/lyrics/_...songLink_songLink_/_server.ts.js"() {
    ...
    init_responses();
    init_chunks();
    GET3 = async ({ params, url }) => {
      if (!params.songLink) {
        return trackNotFound("not given");
      }
      const match4 = params.songLink.match(SongLinkRegex);
      if (!match4) {
...
// .svelte-kit/output/server/entries/matchers/trackUri.js
var trackUri_exports = {};
__export(trackUri_exports, {
  match: () => match
});
var match;
var init_trackUri = __esm({
  ".svelte-kit/output/server/entries/matchers/trackUri.js"() {
    init_regex();
    match = (param) => {
...
// .svelte-kit/output/server/entries/matchers/trackId.js
var trackId_exports = {};
...
// .svelte-kit/output/server/entries/matchers/songLink.js
var songLink_exports = {};
__export(songLink_exports, {
  match: () => match3
});
var match3;
var init_songLink = __esm({
  ".svelte-kit/output/server/entries/matchers/songLink.js"() {
    init_regex();
    match3 = (param) => {
...
function negotiate(accept, types2) {
  ...
  accept.split(",").forEach((str, i) => {
    const match4 = /([^/]+)\/([^;]+)(?:;q=([0-9.]+))?/.exec(str);
    if (match4) {
      const [, type, subtype, q = "1"] = match4;
...
function escape_html_attr(str) {
  const escaped_str = str.replace(escape_html_attr_regex, (match4) => {
    if (match4.length === 2) {
      return match4;
    }
    return escape_html_attr_dict[match4] ?? `&#${match4.charCodeAt(0)};`;
  });
  return `"${escaped_str}"`;
}
var replacements = {
...
function serialize_data(fetched, filter, prerendering2 = false) {
  ...
  const safe_payload = JSON.stringify(payload).replace(pattern, (match4) => replacements[match4]);
  const attrs = [
  ...
  if (!prerendering2 && fetched.method === "GET" && cache_control && !varyAny) {
    const match4 = /s-maxage=(\d+)/g.exec(cache_control) ?? /max-age=(\d+)/g.exec(cache_control);
    if (match4) {
      const ttl = +match4[1] - +(age ?? "0");
...
function exec(match4, params, matchers) {
  const result = {};
  const values = match4.slice(1);
...
async function respond(request, options2, manifest2, state) {
  ...
  if (!state.prerendering?.fallback) {
    ...
    for (const candidate of manifest2._.routes) {
      const match4 = candidate.pattern.exec(decoded);
      if (!match4)
        continue;
      const matched = exec(match4, candidate.params, matchers);
      if (matched) {
        route = candidate;
...
var manifest = (() => {
  ...
  return {
    ...
    _: {
      client: { "start": "_app/immutable/entry/start.CJi4tg9i.js", "app": "_app/immutable/entry/app.DLCX8wXf.js", "imports": ["_app/immutable/entry/start.CJi4tg9i.js", "_app/immutable/chunks/entry.Bmp-AC5S.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/entry/app.DLCX8wXf.js", "_app/immutable/chunks/scheduler.BUtQ6AGX.js", "_app/immutable/chunks/index.COp9-3vz.js"], "stylesheets": [], "fonts": [], "uses_env_dynamic_public": false },
      nodes: [
      ...
      routes: [
        ...
        {
          id: "/lyrics/[trackUri=trackUri]",
          pattern: /^\/lyrics\/([^/]+?)\/?$/,
          params: [{ "name": "trackUri", "matcher": "trackUri", "optional": false, "rest": false, "chained": false }],
          page: null,
          endpoint: __memo(() => Promise.resolve().then(() => (init_server_ts(), server_ts_exports)))
        },
        {
          id: "/lyrics/[trackId=trackId]",
          pattern: /^\/lyrics\/([^/]+?)\/?$/,
          params: [{ "name": "trackId", "matcher": "trackId", "optional": false, "rest": false, "chained": false }],
          page: null,
          endpoint: __memo(() => Promise.resolve().then(() => (init_server_ts2(), server_ts_exports2)))
        },
        {
          id: "/lyrics/[...songLink=songLink]",
          pattern: /^\/lyrics(?:\/(.*))?\/?$/,
          params: [{ "name": "songLink", "matcher": "songLink", "optional": false, "rest": true, "chained": true }],
          page: null,
      ...
      matchers: async () => {
        const { match: trackUri } = await Promise.resolve().then(() => (init_trackUri(), trackUri_exports));
        const { match: trackId } = await Promise.resolve().then(() => (init_trackId(), trackId_exports));
        const { match: songLink } = await Promise.resolve().then(() => (init_songLink(), songLink_exports));
        return { trackUri, trackId, songLink };
      },
      server_assets: {}
    }
  };
